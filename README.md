...
* **Low-Level Hardware Hook:** Reads physical mouse clicks directly from the hardware. 100% bug-free "Toggle" and "Hold" modes.
* **Smart Mouse Detection:** Automatically scans your USB ports to detect gaming hardware (Logitech, Razer, Corsair, SteelSeries, etc.).
* **Cloud-Synced Security:** HWID locked keys, real-time IP/Country verification, and Smart Sessions (login once, play forever).
...
5. **Choose Mode:** Select **Hold** (clicks while you press the bind) or **Toggle** (press once to turn on, press again to turn off).
6. **Enable & Dominate:** Check the "Enable" box and you are ready for combat!
